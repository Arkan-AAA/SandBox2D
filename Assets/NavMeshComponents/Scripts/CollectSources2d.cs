...
namespace NavMeshPlus.Extensions
{
    ...
    public class CollectSources2d : NavMeshExtension
    {
        ...
        )
        {
            ...
            {
                navNeshState.worldBounds.Encapsulate(
                    CalculateGridWorldBounds(
                        surface,
                        navNeshState.worldToLocal,
        ...
        private static Bounds CalculateGridWorldBounds(
            NavMeshSurface surface,
        ...
        )
        {
            ...
            {
                var lbounds = NavMeshSurface.GetWorldBounds(
                    worldToLocal * tilemap.transform.localToWorldMatrix,
                    tilemap.localBounds
                );
